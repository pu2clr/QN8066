...
void handleRoot() {
  ...
  htmlPage += "<option value=\"3\">Inf./Sports</option>";
  htmlPage += "<option value=\"4\">Sport/Talk</option>";
  htmlPage += "<option value=\"5\">Education/Rock</option>";
  htmlPage += "<option value=\"7\">Cult./Adult hits</option>";
  htmlPage += "<option value=\"8\">Science/S.rock</option>";
  htmlPage += "<option value=\"10\">Pop Mus/Country</option>";
  htmlPage += "<option value=\"16\">Weather/Rhythm</option>";
  htmlPage += "<option value=\"20\">Religion</option>";
  htmlPage += "<option value=\"29\">Doc./Weather</option>";
  htmlPage += "<option value=\"30\">Alarm/Emerg.</option>";
...
void handleFormSubmit() {
  ...
  String rds_dt = server.arg("rds_dt");
