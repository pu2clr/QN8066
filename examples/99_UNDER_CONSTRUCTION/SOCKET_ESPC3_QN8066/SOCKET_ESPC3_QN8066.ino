/*
  ESPC3 Dev Modeule version.

  The ESPC3 Module is a microcontroller from the ESP series developed by Espressif.
  The ESP32-C3 is a single-core Wi-Fi and Bluetooth 5 (LE) microcontroller SoC based on the RISC-V architecture. 
  It balances power, I/O capabilities, and security, offering a cost-effective solution for connected devices. 
  Its dual connectivity enables easy configuration and supports diverse use cases.
